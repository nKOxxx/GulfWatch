...
class LocationExtractor:
    ...
    LOCATION_PATTERNS = {
        ...
        # Qatar
        'Doha': ['doha', 'west bay', 'the pearl', 'lusail', 'الدوحة', 'لوسيل'],
        'Al Wakrah': ['al wakrah', 'الوكرة'],
        'Al Khor': ['al khor', 'الخور'],
        'Al Rayyan': ['al rayyan', 'الريان'],
        'Umm Salal': ['umm salal', 'أم صلال'],
        'Al Shamal': ['al shamal', 'الشمال'],
        'Lusail': ['lusail city', 'مدينة لوسيل'],
        
        # Saudi Arabia
        'Riyadh': ['riyadh', 'king fahd road', 'الرياض'],
        'Jeddah': ['jeddah', 'king abdullah', 'جدة'],
        ...
        'Khamis Mushait': ['khamis', 'خميس مشيط'],
    ...
    COORDINATES = {
        ...
        'Al Rayyan': (25.2867, 51.4333),
        'Umm Salal': (25.4697, 51.3975),
        'Al Shamal': (26.1000, 51.2167),
        'Lusail': (25.4175, 51.5075),
        ...
        'Buraidah': (26.3330, 43.9750),
        'Najran': (17.5656, 44.2289),
        'Jazan': (16.9094, 42.5677),
        'Yanbu': (24.0873, 38.0622),
        'Jubail': (27.0174, 49.6225),
        'Khamis Mushait': (18.3000, 42.7333),
        'Qassim': (26.2833, 43.5000),
        'Eastern Province': (26.2667, 50.2000),
